...
<li><a href="form.php">Home Page</a></li>
    ...
    <div class="float-container">
        ...
        <h2>PHP functions</h2>
        <p>Functions are re-usable blocks of code that can be called multiple times and can either be user-defined (created by 
            the user) or they can be existing built-in functions. The syntax of them are:
        </p>
        <p>function foo() {<br>  executed code; <br>}</p>
        <p>foo is the name of the function, within the brackets is the argument that is passed when the function is called, and tehe argument can 
            then be accessed and changed within the function foo. If it is left empty then it means nothing is passed to the function.
            In the example below, the function lastName is called twice and both 'Sarah' and 'Matthew' are the arguments passed to the function.
             the function is taking in the passed argument and adding Smith to the end of it as well as a line break.
        </p>
